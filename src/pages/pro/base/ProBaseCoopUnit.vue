<template>
    ...
    >
        <el-tabs v-model="activeName" type="card" class="full-content">
            <el-tab-pane label="合作单位管理" name="first" style="width: 100%;height: 100%;">
            ...
            <el-tab-pane label="联系人信息" name="second" style="width: 100%;height: 100%">
                <pro-base-contacter style="width: 100%;height: 100%"></pro-base-contacter>
            </el-tab-pane>
        </el-tabs>
        <ice-dialog v-dialogDrag :title="`${dialogEditReadonly?'查看':(editData.oid?'编辑':'新增')}合作单位信息`" custom-class="ice-dialog" center
            ...
            <div class="ice-container">
                <el-form :disabled="dialogEditReadonly" :model="editData" :rules="editRules" label-position="right"
                    ...
                    <el-row :gutter="60">
                        <el-col :span="8">
                            <el-form-item label="合作单位名称:" label-width="120px" prop="unitname">
                                <el-input placeholder="合作单位名称"  v-model="editData.unitname" maxlength="100" :showWordLimit="true"></el-input>
                            </el-form-item>
                        </el-col>
                        <el-col :span="8">
                            <el-form-item label="组织机构代码:" label-width="120px" prop="unitcode">
                                <el-input :disabled="editData.oid?true:false" placeholder="组织机构代码"
                                          v-model="editData.unitcode" maxlength="9" :showWordLimit="true"></el-input>
                            </el-form-item>
                        </el-col>
                        <el-col :span="8">
                            <el-form-item label="分类:" label-width="120px" prop="unitType">
                                <ice-select placeholder="分类"
                                            map-type-code="PRO_UNIT_TYPE"
                    ...
                    <el-row :gutter="60">
                        ...
                        <el-col :span="8">
                            <el-form-item label="邮政编码:" label-width="120px" prop="postcode">
                                <el-input placeholder="邮政编码" v-model="editData.postcode" maxlength="6" :showWordLimit="true"></el-input>
                            </el-form-item>
                        </el-col>
                        <el-col :span="8">
                            <el-form-item label="电子邮件:" label-width="120px" prop="email">
                                <el-input placeholder="电子邮件" v-model="editData.email" type="email" maxlength="20"></el-input>
                            </el-form-item>
                        </el-col>
                    </el-row>
                    <el-row :gutter="60">
                        <el-col :span="8">
                            <el-form-item label="企业法人:" label-width="120px" prop="incor">
                                <el-input placeholder="企业法人" v-model="editData.incor" maxlength="60" :showWordLimit="true"></el-input>
                            </el-form-item>
                        </el-col>
                        <el-col :span="8">
                            <el-form-item label="注册资金币种:" label-width="120px" prop="fundtype">
                                <el-input placeholder="注册资金币种" v-model="editData.fundtype"  maxlength="60" :showWordLimit="true"></el-input>
                            </el-form-item>
                        </el-col>
                        <el-col :span="8">
                            <el-form-item label="注册资金(万):" label-width="120px" prop="fund">
                                <el-input-number placeholder="0" v-model="editData.fund" :min="0"  maxlength="15" :showWordLimit="true" @change="fundVal"></el-input-number>
                            </el-form-item>
                        </el-col>
                    </el-row>
                    ...
                    <el-row :gutter="60">
                        <el-col :span="12">
                            <el-form-item label="开户银行:" label-width="120px" prop="bank">
                                <el-input placeholder="开户银行" v-model="editData.bank"  maxlength="60" :showWordLimit="true"></el-input>
                            </el-form-item>
                        </el-col>
                        <el-col :span="12">
                            <el-form-item label="开户账号:" label-width="120px" prop="acccount">
                                <el-input placeholder="开户账号" v-model="editData.acccount"  maxlength="60" :showWordLimit="true"></el-input>
                            </el-form-item>
                        </el-col>
                    </el-row>
                    ...
                    <el-row :gutter="60">
                        <el-col :span="12">
                            <el-form-item label="资质:" label-width="120px" prop="aptitude">
                                <el-input placeholder="资质" v-model="editData.aptitude"  maxlength="60" :showWordLimit="true"></el-input>
                            </el-form-item>
                        </el-col>
                        <el-col :span="12">
                            <el-form-item label="传真:" label-width="120px" prop="fax">
                                <el-input placeholder="传真" v-model="editData.fax"  maxlength="60" :showWordLimit="true"></el-input>
                            </el-form-item>
                        </el-col>
                    </el-row>
                    ...
                    <el-row :gutter="60">
                        <el-col :span="12">
                            <el-form-item label="企业地址:" label-width="120px" prop="unitAddress">
                                <el-input placeholder="企业地址" v-model="editData.unitAddress"  maxlength="60" :showWordLimit="true"></el-input>
                            </el-form-item>
                        </el-col>
                        <el-col :span="12">
                            <el-form-item label="企业网址:" label-width="120px" prop="url">
                                <el-input placeholder="企业网址" v-model="editData.url" maxlength="128" :showWordLimit="true"></el-input>
                            </el-form-item>
                        </el-col>
                    </el-row>
        ...
        <el-dialog v-dialogDrag title="联系人维护" custom-class="ice-dialog" center
                   :visible.sync="dialogVisibleProBaseContacter"
                   width="1000px" append-to-body :close-on-click-modal="false">
            <pro-base-contacter ref="$contacter" :customerId="customerId" :unitName="unitName"></pro-base-contacter>
        </el-dialog>
...
<script>
    ...
    import ProBaseContacter from "./ProBaseContacter";
    import IceDialog from "../../../components/common/base/IceDialog";

    export default {
        name: "ProBaseCoopUnit",
        data() {
            let ncolumns = [{label: 'oid', code: 'oid', hidden: true},
                ...
                {label: '合作单位名称', code: 'unitname', width: 200, required: true},
                {label: '分类', code: 'unitType', width: 190, mapTypeCode: "PRO_UNIT_TYPE", required: true},
                {label: '企业性质', code: 'quality', width: 100, mapTypeCode: "PRO_QUALITY", required: true},
                {label: '企业法人', code: 'incor', width: 100},
                {label: '组织代码', code: 'unitcode', width: 100, required: true},
                {label: '企业网站', code: 'url', width: 100},
                {label: '企业地址', code: 'unitAddress', width: 190}]
            return {
                query: common.toQuery(ncolumns),
                columns: ncolumns,
                operations: [{name: '详情', callback: this.viewItem},
                    {name: '联系人', callback: this.userItem},
                ...
                activeName: 'first',
                customerId: '',
                dialogVisibleProBaseContacter: false,
                unitName:'',
            }
        },
        methods: {
            ...
            saveData() {
                this.$refs['editForm'].validate((valid) => {
                    ...
                    this.$axios.post("/pro/ProBaseCoopUnit/saveOrUpdate", this.editData)
                        .then(result => {
                            console.log(result);
            ...
            userItem(row) {
                this.dialogVisibleProBaseContacter = true;
                this.customerId = row.oid;
                this.unitName = row.unitname;
                this.$nextTick(() => {
                    this.$refs.$contacter.refreshGrid();
                })
            },
            viewItem(row) {
                this.dialogEditVisible = true;
            ...
            delItem(row) {
                this.$confirm('确定要删除吗？删除后不可恢复，请谨慎操作！！！', '提示', {
                    ...
                    this.$axios.delete("/pro/ProBaseCoopUnit/del", {"params": {"id": row.oid}})
                        .then(result => {
                            console.log(result);
        ...
        components: {IceDialog, ProBaseContacter, IceSelect, IceQueryGrid}
    }
</script>
