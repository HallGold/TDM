              ...
              <el-col :span="8">
                <el-form-item label="实验方式:"
                  ...
                  <el-select v-model="form.theway"
                             ...
                             clearable
                             @change="changeTheway">
                    <el-option v-for="item in thewayOptions"
                               :key="item.value"
                               :label="item.label"
                               :value="item.value">
                    </el-option>
            ...
            <div class="middle-child-box"
              ...
              <ul>
                <li v-for="item in equipment"
                    ...
                    ref="equipmentRef"
                    :class="isHandleer==true?{Selected: sectOid==item.equipmentId}:'Selected'"
                    :id="item.equipmentId">
