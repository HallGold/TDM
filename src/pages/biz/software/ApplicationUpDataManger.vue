...
<script>
    ...
    export default {
        ...
        data(){
            return{
                query:[
                    ...
                    {type: 'static',  code: "updateType",exp:"=",value:'UPDATE'}
                ],
                columns:[
                    {code:"oid",hidden:true},
                    {label: '申请单号', code: 'afNo', width: 170},
                    {label: '软件名称', code: 'softName', width: 270},
                    {label: '申请原因', code: 'afReason', width: 360},
        ...
        methods:{
            ...
            /**查看*/
            lookItem(row){
                this.$router.push("/biz/software/ApplicationUpData?dataId="+row.oid);
            },
            /**编辑*/
            updataItem(row){
                this.$router.push("/biz/software/ApplicationUpData?dataId="+row.oid);
