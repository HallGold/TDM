    ...
    <div style="flex-grow: 1;display: flex;flex-direction: column;width: 100%">
        ...
        <ice-dialog :title="tittle" :visible.sync="dialogVisible"
            ...
            <div class="dialog-footer ice-button-bar" slot="footer">
                ...
                <el-button type="primary" :disabled="checkDisable" v-if="check" @click="save(1)">发 布</el-button>
            ...
            return {
                ...
                startaandstop: {
                    ...
                    operations: [
                        ...
                        {
                            name: '删除', callback: this.deleteAcl, isShow: function (row) {
                                return row.state == 2 ? true : false;
                            }
                        },
                        {
                            name: '编辑', callback: this.updateRow, isShow: function (row) {
                                return row.state == 2 ? true : false;
                            }
                        },
                    ]
                ...
                biz: {
                    dataUrl: "/biz/BizStartandstopRecord/searchByPage?type=1",
                    query: [
                        tabChange,
                ...
                technology: {
                    dataUrl: "/biz/BizStartandstopRecord/searchByPage?type=2",
                    query: [
                        tabChange,
                ...
                equipment: {
                    dataUrl: "/biz/BizStartandstopRecord/searchByPage?type=3",
                    query: [
                        tabChange,
