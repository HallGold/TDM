    ...
    <div style="flex-grow: 1;display: flex;flex-direction: column;width: 100%">
        ...
        <ice-dialog :title="tittle" :visible.sync="dialogVisible"
                    ...
                    <ice-form-group name="操作人员">
                        <div>
                            <div class="ice-grid-button-bar">
                                <el-button type="primary" icon="el-icon-plus" @click="showSelectUser">新增</el-button>
                            </div>
            ...
            <div class="dialog-footer ice-button-bar" slot="footer">
                <el-button type="primary" :disabled="checkDisable" v-if="check" @click="save(2)">保 存</el-button>
                <el-button type="primary" v-if="check" @click="save(1)">发 布</el-button>
...
<script>
    ...
    export default {
        ...
        data() {
            let tabChange = {
                ...
                click: value => {
                    ...
                    this.refreshAndPageReset();
                },
                tablist: [
                    {label: '启停信息', value: 'startaandstop'},
                    {label: '业务服务', value: 'biz'},
                    {label: '技术服务', value: 'technology'},
            ...
            return {
                ...
                startaandstop: {
                    dataUrl: "/biz/BizStartandstopRecord/searchByTypePage?recordType=1",
                    query: [
                        tabChange,
                    ...
                    columns: [
                        ...
                        {label: '状态', code: 'state', width: 80, mapTypeCode: "PUBLISH_STATE"}
                    ],
                    buttons: [
                        {name: '导出', icon: 'el-icon-plus', type: 'export'}
                    ],
                    operations: [
                        {name: '查看', dbclick: true, callback: this.checkLook},
                        {name: '撤销发布', callback: this.repeal,isShow:function (row) {
                                return row.state == 1?true:false;
                            }},
                        {name: '编辑', callback: this.updateRow},
                        {name: '删除', callback: this.deleteAcl},
                    ]
                },
                biz: {
                    dataUrl: "/biz/BizStartandstopRecord/searchByPage?recordType=1",
                    query: [
                        tabChange,
                        {type: 'static', label: '类型', code: 'type', value: 1},
                        {type: 'input', label: '记录单号', code: 'recordId', value: ''},
                        {type: 'input', label: '服务名称', code: 'psbcName', value: ''},
                        {type: 'input', label: '服务分类', code: 'categoryname', value: ''},
                        {type: 'input', label: '设备名称', code: 'devname', value: ''},
                    ...
                    columns: [
                        {code: 'oid', hidden: true},
                        {label: '记录单号', code: 'recordId', width: 200, sortable: true},
                        {label: '区域', code: 'area', width: 120, sortable: true},
                        {label: '服务名称', code: 'psbcName', width: 110, sortable: true},
                        {label: '是否影响服务', code: 'isAffectService', width: 120, mapTypeCode: "YES_NO"},
                        {label: '停用原因', code: 'reason', width: 120, sortable: true, mapTypeCode: "REASON"},
                        {label: '服务启动时间', code: 'startTime', width: 130, sortable: true},
                        {label: '服务停用时间', code: 'stopTime', width: 130, sortable: true},
                        {label: '总耗时(分种)', code: 'expendTime', width: 130, sortable: true},
                        {label: '创建人', code: 'creatorName', width: 80},
                        {label: '创建时间', code: 'createTime', width: 200, sortable: true},
                        {label: '操作人员', code: 'operatorName', width: 100, sortable: true}
                    ],
                ...
                technology: {
                    dataUrl: "/biz/BizStartandstopRecord/searchByPage?recordType=2",
                    query: [
                        tabChange,
                        {type: 'static', label: '类型', code: 'type', value: 2},
                        {type: 'input', label: '记录单号', code: 'recordId', value: ''},
                        {type: 'input', label: '服务名称', code: 'psbcname', value: ''},
                        {type: 'input', label: '服务分类', code: 'categoryname', value: ''},
                        {type: 'input', label: '设备名称', code: 'devname', value: ''},
                    ...
                    columns: [
                        ...
                        {label: '记录单号', code: 'recordId', width: 200, sortable: true},
                        {label: '区域', code: 'area', width: 120, sortable: true},
                        {label: '服务大类', code: 'pARENTNAME', width: 110, sortable: true},
                        {label: '服务分类', code: 'categoryname', width: 110, sortable: true},
                        {label: '是否影响服务', code: 'isAffectService', width: 120, mapTypeCode: "YES_NO"},
                        {label: '停用原因', code: 'reason', width: 120, sortable: true, mapTypeCode: "REASON"},
                        {label: '服务启动时间', code: 'startTime', width: 130, sortable: true},
                ...
                equipment: {
                    dataUrl: "/biz/BizStartandstopRecord/searchByPage?recordType=3",
                    query: [
                        tabChange,
                        {type: 'static', label: '类型', code: 'type', value: 3},
                        {type: 'input', label: '记录单号', code: 'recordid', value: ''},
                        {type: 'input', label: '服务名称', code: 'psbcname', value: ''},
                        {type: 'input', label: '服务分类', code: 'categoryname', value: ''},
                        {type: 'input', label: '设备名称', code: 'devname', value: ''},
                    ...
                    columns: [
                        ...
                        {label: '记录单号', code: 'recordId', width: 200, sortable: true},
                        {label: '区域', code: 'area', width: 120, sortable: true},
                        {label: '设备名称', code: 'devName', width: 110, sortable: true},
                        {label: '是否影响服务', code: 'isAffectService', width: 120, mapTypeCode: "YES_NO"},
                        {label: '停用原因', code: 'reason', width: 120, sortable: true, mapTypeCode: "REASON"},
                        {label: '服务启动时间', code: 'startTime', width: 130, sortable: true},
                        {label: '服务停用时间', code: 'stopTime', width: 130, sortable: true},
        ...
        methods: {
            ...
            repeal(row){
                if(row.state == 2){
                    this.$message.warning("请选择已发布的服务启停进行操作！")
                }else{
                    this.$axios.get('/biz/BizStartandstopRecord/repeal', {params: {id: row.oid}}).then(result => {
