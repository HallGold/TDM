                ...
                <el-form :rules="formRules" :model="devEnterNetData" status-icon :ref="PAGE_ENUM.REFS.FORM.REF">
                    ...
                    <ice-grid-layout name="入网设备基本信息" :columns="2">
                        ...
                        <ice-editable-table :data="devEnterNetData.detailList" ref="executeTable" layout="2"
                            ...
                            <el-table-column
                                    label="设备名称" fixed width="130" prop="name">
                            ...
                            <el-table-column
                                    label="安可设备"
                                    width="120" prop="isSafeDev">
                            </el-table-column>
                            <el-table-column
                                    label="设备所属"
                                    width="120" prop="devBelong">
                            </el-table-column>
                        ...
                        <el-form-item label="申请涉密等级" label-width="140px">
                            <ice-select map-type-code="devSecretLevel" placeholder="请选择"
                                        v-model="devEnterNetData.afterSecretLevel"
                                        :disabled="flowScope.formReadonly"></ice-select>
                        </el-form-item>
                        <el-form-item label="定密后是否入网" label-width="140px">
                            <ice-select map-type-code="MAC_ENABLED" placeholder="请选择"
                                        v-model="devEnterNetData.isAccessNetwork"
                                        :disabled="flowScope.formReadonly"></ice-select>
                        </el-form-item>
                        <el-form-item label="使用范围" label-width="140px">
