<template>
    <div class="content-filled">
        <ice-query-grid data-url="/biz/questionnaire/QuesPublishInfo/pageList"
                        :query="query"
        ...
        <ice-dialog title="调查结果详情查看" :visible.sync="detailVisible" width="900px" height="600px" remounted>
            <ice-query-grid data-url="/biz/questionnaire/QuesUserAnswers/list"
                            :query="detailQuery"
        ...
        <ice-dialog title="人员详情查看" :visible.sync="statisticsUsersVisible" width="1000px" height="600px" remounted>
            <ice-query-grid data-url="/biz/questionnaire/QuesUserAnswers/getOptionUsers"
    ...
    export default {
        ...
        methods: {
            ...
            loadStatistic(id, deptCode) {
                this.loading = true
                this.$axios.get(`/biz/questionnaire/QuesUserAnswers/getStatistics?id=${id}${deptCode ? '&deptCode=' + deptCode : ''}`)
                    .then(({data}) => {
