                ...
                <el-form-item label="检查报告" prop="" layout="2">
                    <div class="attachmentBorder">
                        <upload-attachment :is-edit="isEdit" :remove-call-back="removeAttachment"
                                           ...
                                           :child-type="ENUMS.ATTACHMENT_MAP.dev_jcbg"
                                           :upload-success="uploadSuccessHandler"
                                           :file-info="mainData.reFileVoList"></upload-attachment>
                    </div>
                    <div class="tableTips" style="margin-top: -8px;height: 10px" v-if="validateType.jcba">请上传检查报告</div>
                </el-form-item>
...
<script>
    ...
    export default {
        name: "permissionProperty_product",
        ...
        methods: {
            ...
            validateAttachment() {
                ...
                return new Promise((resolve, reject) => {
                    if (!_this.attachmentMap[this.ENUMS.ATTACHMENT_MAP.dev_jcbg] || _this.attachmentMap[this.ENUMS.ATTACHMENT_MAP.dev_jcbg].length == 0) {
                        _this.validateType.jcba = true;
                        _return = false;
                    } else {
                        _this.validateType.jcba = false;
                        _return = true;
                    }
