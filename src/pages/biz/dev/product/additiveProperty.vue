        ...
        <el-form :model="mainData"
            ...
            <ice-grid-layout :columns="3" name="附加属性">
                ...
                <el-form-item label="质保期" prop="commDTO.qualityDate">
                    <el-date-picker v-model="mainData.commDTO.qualityDate" :picker-options="{disabledDate(time) {return timeFilter(time)}}"></el-date-picker>
                </el-form-item>
                ...
                <el-form-item label="购置时间" prop="commDTO.buyDate">
                    <el-date-picker v-model="mainData.commDTO.buyDate" :picker-options="{disabledDate(time) {return timeFilter(time)}}"></el-date-picker>
                </el-form-item>
                ...
                <el-form-item label="软件版本" prop="extendData.softVersion">
                    <el-input v-model="mainData.extendData.softVersion"></el-input>
                </el-form-item>
