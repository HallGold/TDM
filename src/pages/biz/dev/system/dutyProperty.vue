            ...
            <ice-grid-layout :columns="3" name="责任相关">
                ...
                <div layout="3">
                    <div class="dutyContent">
                        <div class="text"><span class="required-star">*</span>系统三员</div>
                        <div style="width: 100%;padding-left: 4px" ref="table">
                            ...
                            <ice-editable-table layout="3" :ref="PAGE_ENUM.REFS.MANAGE_TABLE.REF"
                                                :data="mainData.dutyDTOList" height="200" :rules="rules"
                                ...
                                <ice-editable-table-column label="电话" :disabled="!isEdit"
...
<script>
    ...
    import {validatePhoneTwo} from "@/pages/biz/dev/js/comm/commValidator.js";
    ...
    export default {
        ...
        data() {
            return {
                ...
                //页面校验规则
                rules: {
                    dutyName: {required: true, message: '请选择主管部门联系人', trigger: 'blur'},
                    deptName: {required: true, message: '请选择主管部门', trigger: 'blur'},
                    userType: {required: true, message: '请选择用户类型'},
                    phone: {required: true, validator: validatePhoneTwo, message: '用户联系方式不能为空'}
                }
            };
        },
        methods: {
            ...
            selectDutyNameConfirm(data) {
                this.mainData.commDTO.dutyPhone = data[0].phone;
            },
            /**
             * 根据code查找相同行
             * @param data
            ...
            onManagersGridValidate() {
                ...
                return new Promise((resolve, reject) => {
                    if (!managersData || managersData.length < _this.ENUMS.MANAGER_TYPE_DATA.properties.length) {
                        ...
                        validate = this.userTypeValidate(managersData, true);
                    }
                    if (validate) {
                        resolve();
                    } else {
