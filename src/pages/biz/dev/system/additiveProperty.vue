...
<script>
    ...
    export default {
        ...
        data() {
            return {
                rulesReport: {//表单字段规则
                    'extendData.origin': [{required: true, message: '请选择来源', trigger: 'blur'}],
                    'extendData.deployMode': [{required: true, message: '请选择部署模式', trigger: 'blur'}],
                    'commDTO.systemLevel': [{required: true, message: '请选择系统级别', trigger: 'blur'}],
                }
            }
        },
        methods: {
