        ...
        data() {
            ...
            return {
                rulesReport: {//表单字段规则
                    ...
                    'commDTO.birthDate': [{required: false, trigger: 'blur'}],
                    'commDTO.buyDate': [{required: false, trigger: 'blur'}],
                    'commDTO.qualityDate': [{required: false, trigger: 'blur'}],
                    ...
                    'commDTO.masterIp': [{validator: validateIP, trigger: 'blur'}, {
                        required: true,
                        message: '请输入IP地址',
                        trigger: 'blur'
                    },],
