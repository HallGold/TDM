<template>
    ...
    <div style="display:flex;flex-direction:column;height:100%;">
        <div style="flex-grow: 1;overflow-y: auto">
            <el-form :model="assign" :rules="formRules" ref="Form">
                <el-row :gutter="10">
    ...
    export default {
        ...
        data() {
            return {
                ...
                queryDept: [
                    {type: 'input', label: '第三方厂商', code: 'unitname', value: '',},
                    {type: 'input', label: '企业性质', code: 'quality', value: '',},
                ],
                queryApplyIn: [
                    ...
                    {type: 'input', label: '申请进入部位', code: 'inLocation', value: '',},
                ],
                formRules: {
            ...
            selectConfirm() {
                if (this.perfect() == true) {
                    if (this.assign.maintainMembers.length !== 0) {
                        ...
                        this.assign.applyIns = applyArray;
                        this.$emit("confirm", this.assign);
                        // this.$router.push("/biz/event/serviceTicket");
                    } else {
