<template>
    <div class="content-filled">
        <ice-query-grid title="应用系统业务数据修改管理"
                        :data-url="INSTITUTE_ENUMS.ACTIONS.SEARCH_BY_TYPE_CODE.URL()+'?typeCode='+this.INSTITUTE_ENUMS.SYSTEM_APPLY_TYPE_DATA.modify.code"
...
<script>
    ...
    export default {
        ...
        methods: {
             ...
             */
            view(e) {
                this.$router.push(this.INSTITUTE_ENUMS.ROUTER.MODIFY_EDIT.URL() + "?dataId=" + e.oid + "&readOnly=true");
            }
        },
        mounted() {
