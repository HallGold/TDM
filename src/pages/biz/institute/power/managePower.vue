<template>
    <div class="content-filled">
        <ice-query-grid title="应用系统权限变更管理"
                        :data-url="INSTITUTE_ENUMS.ACTIONS.SEARCH_BY_TYPE_CODE.URL()+'?typeCode='+this.INSTITUTE_ENUMS.SYSTEM_APPLY_TYPE_DATA.power.code"
                        :query="POWER_MANAGE_PAGE_ENUM.MANAGE_GRID.QUERY"
                        :columns="POWER_MANAGE_PAGE_ENUM.MANAGE_GRID.COLUMNS"
                        :ref="POWER_MANAGE_PAGE_ENUM.MANAGE_GRID.REF"
                        :operations="POWER_MANAGE_PAGE_ENUM.MANAGE_GRID.OPERATIONS"
                        :operationsWidth=100
                        :minHeight="530"
                        :buttons="POWER_MANAGE_PAGE_ENUM.MANAGE_GRID.BUTTONS"></ice-query-grid>
    </div>
</template>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            initColumns() {
                let _this = this;
                this.POWER_MANAGE_PAGE_ENUM.MANAGE_GRID.COLUMNS = [
                    ...
                    {
                        label: '变更有效期', code: 'changeExpiration', width: 180, formatter: row => {
                            return "截止 " + row.changeExpiration;
                        }
                    },
            ...
            initQuerys() {
                let _this = this;
                this.POWER_MANAGE_PAGE_ENUM.MANAGE_GRID.QUERY = [
             ...
             */
            initOperations() {
                this.POWER_MANAGE_PAGE_ENUM.MANAGE_GRID.OPERATIONS = [
            ...
            view(e) {
                e
                this.$router.push(this.INSTITUTE_ENUMS.ROUTER.POWER_EDIT.URL() + "?dataId=" + e.oid + "&readOnly=true");
            }
        },
        mounted() {
