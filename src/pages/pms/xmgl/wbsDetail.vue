    ...
    <div style="width: 100%;">
        <!--弹出模态框-->
            <el-form :model="formModel" :rules="rules" ref="form" :v-loading="loading">
                <el-tabs type="border-card" v-model="moname" style="height: 700px" @tab-click="handleTabs">
                        ...
                        <el-row :gutter="20">
                            ...
                            <el-col :span="24">
                                <el-form-item label="任务内容" label-width="110px" prop="rwname">
                                    <el-input v-model="formModel.rwname" placeholder="不超过100个字" maxlength="100"
                        ...
                        <el-row :gutter="20">
                            ...
                            <el-col :span="12">
                                <el-form-item label="密级" label-width="110px" prop="dataSecretLevcode">
                                    <ice-select v-bind="$attrs" :disabled="isEdit" v-model="formModel.dataSecretLevcode"
                        ...
                        <el-row :gutter="20">
                            <el-col :span="12">
                                <el-form-item label="任务模式" label-width="110px" prop="rwms" map>
                                    <ice-select :disabled="isEdit" v-model="formModel.rwms" map-type-code="RWMS">
                                    </ice-select>
                                </el-form-item>
                            </el-col>
                            <el-col :span="12">
                            ...
                            <el-col :span="12">
                                <el-form-item label="工期(天)" label-width="110px" prop="rwgq">
                                    <el-input-number :disabled="isEdit" :min=0 v-model="formModel.rwgq"
                                                     @change="rwgqChangeEvent"></el-input-number>
                                </el-form-item>
                            </el-col>
                        </el-row>
                        <el-row :gutter="20">
                            <el-col :span="12">
                                <el-form-item label="计划开始日期" label-width="110px" prop="dateJhStar">
                                    <el-date-picker :disabled="isEdit" :picker-options="pickerOptions"
                        ...
                        <el-row :gutter="20">
                            <el-col :span="12">
                                <el-form-item label="责任人" label-width="110px" prop="rwfzr">
                                    <ice-persion-selector :mode="isEdit?'readonly':'onlySelect'" chooseItem="single"
                        ...
                        <el-row :gutter="20">
                            <el-col :span="12">
                                ...
                                <el-form-item label="资源类型" label-width="110px" prop="zylx" map>
                                    <ice-select :disabled="isEdit" v-model="formModel.zylx" map-type-code="ZYLX">
                                    </ice-select>
                                </el-form-item>
                            </el-col>
                            <el-col :span="12">
                                <el-form-item label="资源名称" label-width="110px" prop="zynqme">
                                    <el-input :disabled="isEdit" v-model="formModel.zynqme"></el-input>
                                </el-form-item>
                            </el-col>
                        </el-row>
                        <el-row :gutter="20">
                        ...
                        <el-row :gutter="20">
                            <el-col :span="12">
                                <el-form-item label="限制类型" label-width="110px" prop="xzlx" map>
                                    <ice-select :disabled="isEdit" v-model="formModel.xzlx" map-type-code="XZLX">
                                    </ice-select>
                                </el-form-item>
                            </el-col>
                            <el-col :span="12">
                        ...
                        <el-row :gutter="20">
                            ...
                            <el-col :span="12">
                                <el-form-item label="财务脱密代码" label-width="110px" prop="cwtmdm">
                                    <el-input :disabled="isEdit" v-model="formModel.cwtmdm"></el-input>
                                </el-form-item>
                            </el-col>
                        </el-row>
                        <el-row :gutter="20">
                            <el-col :span="12">
                                <el-form-item label="预算号" label-width="110px" :prop="isYscodeEdit?'yscode':'#'">
                                    <el-input :disabled="isEdit || !isYscodeEdit" v-model="formModel.yscode"
                            ...
                            <el-col :span="24">
                                <el-form-item label="任务目标" label-width="110px" prop="rwmb">
                                    <el-input :disabled="isEdit" placeholder="不超过650个字" maxlength="650"
                                              show-word-limit v-model="formModel.rwmb" type="textarea" :rows="2">
                                    </el-input>
                                </el-form-item>
                            </el-col>
                        </el-row>
                    ...
                    <el-tab-pane v-if="!isModel" name="upload" label="附件上传">
                        <ATTACHMENT v-bind="$attrs" :data="formModel.fileList" ref="attachment" :is-handleer="!isEdit"></ATTACHMENT>
                    </el-tab-pane>
                    <el-tab-pane v-if="!isModel" name="cgyd" label="成果约定">
                        ...
                        <WBSCGYD isDetail="1" :syncResize="moname" v-bind="$attrs" :data="formModel.cgydList" :rwdata="formModel" ref="cgyd" :closeDialog="closeDialog"
            ...
            <!--&lt;!&ndash;模态框底部定义按钮&ndash;&gt;-->
            <!--<div class="ice-button-bar">-->
                <!--&lt;!&ndash; <slot name="footer" :row="formModel"></slot> &ndash;&gt;-->
...
<script>
    ...
    export default {
        ...
        computed: {
            ...
            wbsoid () {
                return this.$route.query.wbsoid;
            }
        },
        //触发事件方法
        methods: {
            ...
            // 获取数据
             getWbsData(wbsoid) {
                 this.$axios.get("/pms/PmsWbs/getPmsWbs", {params: {id: wbsoid}})
                    .then(result => {
                        this.wbsData = result.data;
                        this.getPeripheralParams(result.data);
                    })
            },
            //周边模块调用，传入参数
            getPeripheralParams(rowData) {
                this.isndrw = rowData.pid == '0'
                //如果任务已经完成，不能编辑
                this.isEdit = true
