    ...
    <div class="ice-container">
        ...
        <ice-dialog :title="title" :visible.sync="visible" width="800px">
            <el-form :model="formModel" status-icon ref="form" :rules="rules" v-loading="loading">
                ...
                <el-row :gutter="20">
                    <el-col :span="12">
                        <el-form-item label="销毁量(kg)" label-width="140px" prop="whpXh">
                            <el-input v-model="formModel.whpXh" placeholder="请输入" type="number"></el-input>
                        </el-form-item>
                    </el-col>
                    <el-col :span="12">
...
<script>
    ...
    export default {
        ...
        data() {
            return {
                ...
                query: [
                    ...
                    {type: 'input', code: 'kfName', label: '工房', exp: 'like', value: ''},
                    ...
                    {
                        type: 'static', code: 'xhYear', exp: '=', value: () => {
                ...
                columns: [
                    ...
                    {label: "工房", code: "kfName", width: 200, sortable: true},
                    ...
                    {
                        label: '销毁数量/kg', code: 'whpXh', width: 200, sortable: true, columns:
                            [
                    ...
                    {label: '销毁量(kg)', code: 'whpXh', width: 200, hidden: true},
                    {label: '销毁量(kg)', code: 'date', width: 200, hidden: true},
        ...
        methods: {
            ...
            async getYears() {
                await this.$axios.get("/pms/QisWhpXhtz/getYears").then(result => {
            ...
            refresh() {
                this.loading = true;
                console.log(this.tablePage, 'tablePage')
                this.tablePage.staticConditions = this.staticQuerys;
                this.$axios.get("/pms/QisWhpXhtz/list", {params: this.tablePage}).then(result => {
                    // console.log(result)
            ...
            async confirm() {
                this.$refs.form.validate((valid) => {
                    if (valid) {
                        this.loading = true;
                        this.$axios.post('/pms/QisWhpXhtz/saveOrUpdate', this.formModel).then(result => {
                            if (this.value != this.formModel.xhYear) {
                                this.getYears();
                                this.value = this.formModel.xhYear;
                            }
                            this.refresh();
                            this.visible = false;
            ...
            handleDel(row) {
                this.$confirm('是否确认删除', '提示', {
                    ...
                    this.formModel = {...row};
                    this.formModel.xhYear = this.value;
                    this.$axios.post('/pms/QisWhpXhtz/delCurrentYear', this.formModel).then(result => {
            ...
            dateChange(value) {
                if (value != 'undefined') {
                    this.formModel.xhYear = value.getFullYear();
                    this.formModel.xhMonth = value.getMonth() + 1;
                }
            }
        },
        watch: {
