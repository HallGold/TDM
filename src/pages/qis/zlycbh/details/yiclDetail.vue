<template>
    <div>
        <ice-dialog title="质量异常处理详情" :visible.sync="visible" width="1200px">
                                ...
                                <el-row :gutter="20">
                                    <el-col :span="24">
                                        <el-form-item label="异常关联" label-width="140px" prop="yclyId">
                                            <el-select ref="ycgl" v-model="bizdata.lycode" placeholder="请选择" :disabled="flowScope.formReadonly">
                                                <el-option
        ...
        data() {
            return {
                ...
                ideas: [
                    ...
                    {label:'ZLYC_OPTION1', value:'已《纠正措施处理单》完成整改'},
        ...
        methods: {
            ...
            getDetail(oid) {
                if (oid && this.previd != oid) {
                    this.previd = oid;
                    this.$axios.get("/pms/QisZlyc/get", {params: {id: oid}})
                        .then(result => {
