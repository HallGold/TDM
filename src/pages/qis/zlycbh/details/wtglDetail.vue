<template>
    <div>
        <ice-dialog title="质量问题归零管理详情" :visible.sync="visible" width="1200px">
                                ...
                                <el-row :gutter="20">
                                    <el-col :span="24">
                                        <el-form-item label="问题关联" label-width="140px" prop="wtlyId">
                                            <el-select v-model="bizdata.wtlyCode" placeholder="请选择" :disabled="flowScope.formReadonly">
                                                <el-option
        ...
        methods: {
            ...
            getDetail(oid) {
                if (oid && this.previd != oid) {
                    this.previd = oid;
                    this.$axios.get("/pms/QisZlwt/get", {params: {id: oid}})
                        .then(result => {
