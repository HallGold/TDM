    ...
    export default {
        ...
        methods: {
            ...
            getRoleSelect() {
                ...
                this.$axios.get("permission/app_constant/byCode", {params: {appCode: 'PMS', code: 'GL_RY_LX'}})
                    .then(result => {
        ...
        computed: {
            ...
            isCanSelectPerson() {
                ...
                return (urlparam == 'pms' || urlparam == 'qis')&&this.isPersonSelect ? true : false;
            }
        },
        created() {
            console.log(this.isCanSelectPerson, 'isCanSelectPerson')
