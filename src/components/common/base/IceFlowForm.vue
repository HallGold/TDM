        ...
        <vue-scroll ref="scroll" :ops="{ bar: { background: '#000', opacity: 0.4, keepShow: true } }"
            ...
            <div class="flow-form-base">
                <div class="flow-form-wrapper" ref="flow-form-wrapper" >
                    <div class="operation-area" v-if="showTitle" :style="{left: formLeft}">
                        <div class="first">
                            <div :title="flowContext.actDefName" class="title">
                                {{ flowContext.actDefName ? flowContext.actDefName : '&nbsp;' }}
                                <div class="secret" v-if="showsecrethint">
                            ...
                            <div class="shr-area">
                                ...
                                <ice-grid-layout :columns="2">
                                    ...
                                    <ice-persion-selector
                                            ...
                                            v-if="item.roleFormula.visible"
                                            @select-confirm="selectConfirm"
                                            v-for="item in flowInstData.nodeUserSetList"
                                            :key="item.nodeId">
                                    </ice-persion-selector>
                                </ice-grid-layout>
                                <slot name="shyj">
                                    <div>
                                        ...
                                        <el-timeline class="shyj">
                                            <el-timeline-item
                                                ...
                                                {{ !item.opinion ?
                                                ( item.nodeId == 'StartEvent'?'':'同意') : '-' + item.opinion }}
                                            </el-timeline-item>
                                        </el-timeline>
                                    </div>
                                </slot>
                ...
                >
                    <div style="padding:10px 30px;">
                        ...
                        <ice-static-persion-selector
                                ...
                                @select-confirm="selectConfirm"
                        ></ice-static-persion-selector>
                        <!--v-if="showNextUser&&nextNodeShow&&flowContext.actInstId"-->
                        <ice-label name="临时处理人" :width="120" v-if="showNextUser&&nextNodeShow&&flowContext.actInstId">
                            <ice-persion-selector :buttonDisabled="false" :noSelectCodes="replacePersonUser" mode="onlySelect" chooseItem="multiple"
                                                  v-model="nextUserNameLy" @select-confirm="selectConfirmPersons">
                            </ice-persion-selector>
                        </ice-label>
